...
class ComparisonWidget(QWidget):
    ...
    def compareSearchEntered(self):
        ...
        print(f"Value of currentLocation before if: {currentLocation}")
    
        if len(self.searchBar3.text()) > 0 and currentLocation:
            global comparedLocation
            comparedLocation = getLocation(self.searchBar3.text())
            print(f"currentLocation in compareSearchEntered (inside if): {currentLocation}")
            print(f"comparedLocation in compareSearchEntered: {comparedLocation}")
        ...
        print(f"Value of currentLocation after if: {currentLocation}")
...
class MainWindow(QMainWindow):
    ...
    def storeComparisonData(self, location1, location2):
        """Stores the comparison data of two locations."""
        if location1 and location2:
            ...
            print(f"Comparison data stored: {self.current_comparisons}") # For debugging
        else:
